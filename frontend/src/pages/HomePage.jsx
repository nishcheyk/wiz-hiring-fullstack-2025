    ...
    async function checkApproval() {
      ...
      if (userType === 'user') {
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/users?adminEmail=admin@gmail.com`
        );
        const users = await res.json();
        const user = users.find(
          u => u.email === localStorage.getItem('userEmail')
        );
    ...
    <div className="main-content animate-fade-in">
      ...
      <div style={{ width: '100%', maxWidth: 900, margin: '0 auto' }}>
        <h1
          ...
          style={{ textAlign: 'left', fontSize: '2rem', marginBottom: 24 }}
        >
          Upcoming Events
        </h1>
        {approved && (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: 15, color: '#aaa' }}>
                    Max bookings per slot: {event.max_bookings_per_slot}
                  </div>
                </li>
              );
            })}
